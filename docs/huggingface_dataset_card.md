...
The historical structured seed and migration record are documented in [the repository migration record](https://github.com/NegativeMeta/weeb-alexandria/blob/main/docs/ANIMADEX_VALUE_ANALYSIS.md). `search_knowledge` returns structured results under the `entities` namespace.
