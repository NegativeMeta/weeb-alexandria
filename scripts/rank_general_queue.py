...
EXCLUDED = {
    ...
    "aki_minoriko", "yumemi_riamu", "saori_(blue_archive)",
    "rosalina", "northern_ocean_princess", "dark_magician_girl",
    "shijou_takane", "sonic_the_hedgehog", "mutsuki_(blue_archive)",
    "senketsu", "tokai_teio_(umamusume)", "sakura_kyoko_(magical_girl)",
    "nero_claudius_(fate/extra)", "kisaragi_chihaya", "kijin_seija",
    "shirasaka_koume", "medusa_(fate)", "edelgard_von_hresvelg",
    "belle_(zenless_zone_zero)", "chloe_von_einzbern", "ereshkigal_(fate)",
    "midori_(blue_archive)",
    "rover_(wuthering_waves)", "takarada_rikka", "sailor_moon", "ishtar_(fate)",
    ...
    "sanji_(one_piece)", "ro-500_(kancolle)", "cu_chulainn_(fate)",
    "arlecchino_(genshin_impact)", "ahri_(league_of_legends)",
    "silence_suzuka_(umamusume)", "tachibana_arisu", "hecatia_lapislazuli",
    "prinz_eugen_(azur_lane)", "jane_doe_(zenless_zone_zero)", "raiden_mei",
    "akiyama_yukari", "uchiha_sasuke",
    "reisalin_stout", "letty_whiterock", "kanna_kamui",
    "minase_iori", "bowsette", "sagisawa_fumika", "medusa_(rider)_(fate)",
    "aki_shizuha", "fu_hua", "exusiai_(arknights)", "shimamura_uzuki",
    "amamiya_ren",
    "jeanne_d&#039;arc_(ruler)_(fate)", "surtr_(arknights)",
    "artoria_pendragon_(lancer)_(fate)", "bridget_(guilty_gear)",
    "basil_(omori)", "kumoi_ichirin", "kieran_(pokemon)", "takagaki_kaede",
    "belfast_(azur_lane)", "koizumi_hanayo", "wise_(zenless_zone_zero)",
    "nessa_(pokemon)", "satono_diamond_(umamusume)", "octoling_player_character",
    "djeeta_(granblue_fantasy)", "mikasa_ackerman", "bronya_zaychik",
    "joseph_joestar", "ruby_rose", "jeanne_d'arc_alter_(avenger)_(fate)",
    ...
    "kuroki_tomoko", "miyako_(blue_archive)", "ruler_(fate/apocrypha)",
    "w_(arknights)",
}
